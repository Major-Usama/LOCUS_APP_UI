import React, {Component} from 'react';
    ...
    export default class ModalButtons extends Component {
        ...
        onClick() {
            {this.state.backgroundColor==="#fff" ?this.setState({backgroundColor:"#7D34E3"}):this.setState({backgroundColor:"#fff"})}
           
            {this.state.color==="#fff" ?this.setState({color:"#7D34E3"}):this.setState({color:"#fff"})}
        }
        render() {
            return (
